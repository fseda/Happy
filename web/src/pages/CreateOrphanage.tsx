...
export default function OrphanagesMap() {
  ...
  function handleSelcetedImage (event: ChangeEvent<HTMLInputElement>) {
        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input multiple onChange={handleSelcetedImage} type="file" id="image[]" name="files" />
          ...
          <fieldset>
            ...
            <div className="input-block">
              <label htmlFor="openingHours">Horario de Funcionamento</label>
              <input 
                id="openingHours" 
                value={openingHours} 
